MPI Pi Estimation Program
====================================

Overview:
---------
This program estimates the value of π using the Monte Carlo method by generating random points
...
- Using MPI_Reduce, all local counts are summed up to the master processor to compute the final estimation of π.
- The program measures and outputs the run-time of the computation, along with the estimated value of π.
- Output format: The program outputs the estimated value of π, followed by the computation time, formatted as "estimated_pi, time_in_seconds".
